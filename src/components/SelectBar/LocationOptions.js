        ...
        <>  {/* 戰南北 */}
            <FormControl>
                ...
                >
                    ...
                    }} value="北部" control={<Radio/>} label="北部"/>
                    <FormControlLabel sx={{
                        "& .MuiFormControlLabel-label": {fontSize: "0.8rem"},
                        "& .MuiSvgIcon-root": {fontSize: "0.8rem"}
                    }} value="中部" control={<Radio/>} label="中部"/>
                    <FormControlLabel sx={{
                        "& .MuiFormControlLabel-label": {fontSize: "0.8rem"},
                        "& .MuiSvgIcon-root": {fontSize: "0.8rem"}
                    }} value="南部" control={<Radio/>} label="南部"/>
                    <FormControlLabel sx={{
                        "& .MuiFormControlLabel-label": {fontSize: "0.8rem"},
                        "& .MuiSvgIcon-root": {fontSize: "0.8rem"}
                    }} value="東部" control={<Radio/>} label="東部"/>
                    <FormControlLabel sx={{
                        "& .MuiFormControlLabel-label": {fontSize: "0.8rem"},
                        "& .MuiSvgIcon-root": {fontSize: "0.8rem"}
                    }} value="離島" control={<Radio/>} label="離島"/>
                </RadioGroup>
            </FormControl>
            {position && <> {/* 選擇縣市 */}
                <hr/>
            ...
            {county && <> {/* 選擇鄉鎮市區 */}
                ...
                <FormControl>
                    ...
                    >
                        ...
                        control={<Checkbox sx={{display: "none"}} checked={all}
                            onChange={handleChangeArea} name={"不限"}/>} label={"不限"}/>
                        {cityData[county].map((area, i) =>
                            ...
                            }} control={<Checkbox county={county} checked={isChecked(area["AreaName"])}
                                onChange={handleChangeArea} name={area["AreaName"]}/>}
                            label={area["AreaName"]}/>
                        )}
                    </FormGroup>
                </FormControl>
