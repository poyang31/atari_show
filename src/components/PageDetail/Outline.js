...
export default function Outline(props) {
    ...
    return (
        <Stack spacing={1}>
            ...
            <Box>
                {tags.map((tag, index) => <PostTag key={index} content={tag.content} type={tag.type}
                    icon={tag.icon}></PostTag>)}
            </Box>
            <Box>
            ...
            <Box>
                <Typography sx={{
                    ...
                    fontWeight: "bold",
                    color: "#FF0000"
                }}>{rentMoney}</Typography>
                <Typography
                    sx={{display: "inline-block", fontSize: "16px", color: "#FF0000", mr: "16px"}}>元/月</Typography>
