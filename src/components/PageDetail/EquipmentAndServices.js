        ...
        <Stack spacing={1}>
            ...
            <Box sx={{pb: 1}}>
                ...
                <Grid container spacing={1} columns={{sm: 6, md: 8}} sx={{p: "4px", pl: "16px"}}>
                    {conditions.a.map((condition, index) => <Condition text={condition} icon={icons[condition]}
                        key={index}/>)}
                </Grid>
            </Box>
            <Box sx={{pb: 1}}>
                ...
                <Grid container spacing={1} columns={{sm: 6, md: 8}} sx={{p: "4px", pl: "16px"}}>
                    {conditions.b.map((condition, index) => <Condition text={condition} icon={icons[condition]}
                        key={index}/>)}
                </Grid>
            </Box>
            <Box sx={{pb: 1}}>
                ...
                <Grid container spacing={1} columns={{sm: 6, md: 8}} sx={{p: "4px", pl: "16px"}}>
                    {conditions.c.map((condition, index) => <Condition text={condition} icon={icons[condition]}
                        key={index}/>)}
                </Grid>
            </Box>
            <Box sx={{pb: 1}}>
                ...
                <Grid container spacing={1} columns={{sm: 6, md: 8}} sx={{p: "4px", pl: "16px"}}>
                    {conditions.d.map((condition, index) => <Condition text={condition} icon={icons[condition]}
                        key={index}/>)}
                </Grid>
            </Box>
            <Box sx={{pb: 1}}>
                ...
                <Grid container spacing={1} columns={{sm: 6, md: 8}} sx={{p: "4px", pl: "16px"}}>
                    {conditions.e.map((condition, index) => <Condition text={condition} icon={icons[condition]}
                        key={index}/>)}
                </Grid>
            </Box>
