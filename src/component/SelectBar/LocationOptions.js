                ...
                <FormControl>
                    ...
                    >
                        {areas[position].map((county, i) =>
                            <FormControlLabel
                                key={i}
                                sx={{"& .MuiFormControlLabel-label": { fontSize: "0.8rem", color: hasChecked(county) && "blue" }, "& .MuiSvgIcon-root": { fontSize: "0.8rem" }}}
                                value={county}
                                control={<Radio/>}
                                label={county}
                            />
                ...
                <FormControl>
                    ...
                    >
                        ...
                        {cityData[county].map((area, i) =>
                            <FormControlLabel key={i} sx={{"& .MuiFormControlLabel-label": { fontSize: "0.8rem", color: isChecked(area["AreaName"]) && "blue" }, "& .MuiSvgIcon-root": { fontSize: "0.8rem" }}} control={<Checkbox county={county} checked={ isChecked(area["AreaName"]) } onChange={handleChangeArea} name={area["AreaName"]} />} label={area["AreaName"]}/>
                        )}
                    </FormGroup>
                </FormControl>
            </>}
